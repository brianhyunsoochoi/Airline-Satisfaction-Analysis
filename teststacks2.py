# ===============================================
# Full Stacking Pipeline — RandomForest + SVM (Same Preprocessing as XGBoost)
# ===============================================
...
def preprocess(df, is_train=True):
    ...
    # Service Quality Score (0.2 weight on Online boarding)
    service_cols = [
...
# ===============================================
# 3️⃣ Run stacking (RandomForest + SVM)
# ===============================================
def run_stacking():
    ...
    # Base models
    print("[3️⃣] Initializing base models (RandomForest + SVM)...")
    base_models = [
